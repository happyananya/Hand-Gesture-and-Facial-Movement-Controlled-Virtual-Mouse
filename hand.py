    ...
    def classify_hands(results):
        ...
        try:
            ...
            if handedness_dict['classification'][0]['label'] == 'Right':
                ...
                if GestureController.dom_hand is None or GestureController.dom_hand is False:
                    GestureController.dom_hand = True
                    print("right")

            else :
                left = results.multi_hand_landmarks[0]
                if GestureController.dom_hand is None or GestureController.dom_hand is True:
